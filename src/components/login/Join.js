...
const Join = () => {
  ...
  const eventHandler = (checked) => {
    console.log("eventHandler checked : " + checked);
    setIsEventChecked(!isEventChecked);
  };

  const eventAlarmHandler = (checked, value) => {
    console.log(checked);
    console.log(value);
    if (checked) {
          ...
          <JoinFormWrapper>
            <form method="post">
              <RowWrapper>
                ...
                <RowButton leftMargin="10px">중복확인</RowButton>
              </RowWrapper>
              <RowWrapper>
                <RowTitle>
              ...
              <RowWrapper>
                ...
                <RowInput />
                <RowButton leftMargin="10px">인증번호 받기</RowButton>
              </RowWrapper>
              <RowWrapper>
                <RowTitle>
              ...
              <tr className="reg_agree">
                ...
                <td className="inner_reg_agree_right">
                  ...
                  <div className="check_view">
                    ...
                    <Link to="#" className="link btn_link btn_agreement">
                      약관보기
                    </Link>
                  </div>
                  <div className="check_view">
                    <label className="check_agree label_block">
                      <input
                        ...
                        checked={
                          checkedItems.includes("privacy_required")
                            ? true
                            : false
                        }
                      />
                  ...
                  <div className="check_view">
                    <label className="check_agree label_block">
                      <input
                        ...
                        checked={
                          checkedItems.includes("privacy_optional")
                            ? true
                            : false
                        }
                      />
                  ...
                  <div className="check_view">
                    <label className="check_agree label_block">
                      <input
                        ...
                        onChange={(e) => {
                          agreeHandler(e.currentTarget.checked, e.target.value);
                          eventHandler(e.currentTarget.checked);
                        }}
                        checked={
                          isEventChecked ||
                          (checkedItems.includes("provision") ? true : false)
              ...
              <div id="formSubmit" className="form_footer">
                <button type="button" className="btn active btn_join">
                  가입하기
                </button>
              </div>
            </form>
