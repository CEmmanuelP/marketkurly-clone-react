        ...
        <div className="products">
          <div className="item item1">
            <div className="inner_item">
              <img
                src="https://img-cf.kurly.com/shop/data/goods/1613639022287l0.jpg"
                width="338"
                height="338"
              />
            </div>
          ...
          <div className="item item1">
            <div className="inner_item">
              <img
                src="https://img-cf.kurly.com/shop/data/goods/1501832513939l0.jpg"
                width="338"
                height="338"
              />
            </div>
          ...
          <div className="item item1">
            <div className="inner_item">
              <img
                src="https://img-cf.kurly.com/shop/data/goods/1504260110990l0.jpg"
                width="338"
                height="338"
              />
            </div>
